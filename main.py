...
def getWeather():
    ...
    api = f"api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}&appid={api_key}&units=metric"
...
day2_temp = Label(second_frame, background= "#eeefea", fg = "#000")
...
day3_temp = Label(third_frame, background= "#eeefea", fg = "#000")
...
fourth_frame_img.place(x = 7, y = 20)
